...
{
    //static string RahyabIP = "http://193.104.22.14:2055/CPSMSService/Access";
    public class ClsSend
    {
        ...
        public string[] SendSMS_Single(string Message, string DestinationAddress)
        {
            ...
            lock (syncLock)
            {
                try
                {
                    ...
                    _StringBuilder.Append(Environment.NewLine);
                    _StringBuilder.Append("<smsBatch company=\"" + RahyabParameters.Shenase + "\" batchID=\"" + RahyabParameters.Shenase + "+" + Identity + "\">");
                    _StringBuilder.Append(Environment.NewLine);
                    ...
                    _StringBuilder.Append(Environment.NewLine);
                    _StringBuilder.Append("<origAddr><![CDATA[" + Validate_Number(RahyabParameters.Number) + "]]></origAddr>");
                    _StringBuilder.Append(Environment.NewLine);
                    ...
                    WebRequest objWebRequest = WebRequest.Create(RahyabParameters.IP);
                    objWebRequest.Method = "POST";
                    objWebRequest.ContentType = "text/xml";
                    byte[] byt = System.Text.Encoding.UTF8.GetBytes(RahyabParameters.Username + ":" + RahyabParameters.Password);
    ...
    public class ClsStatus
    {
        ...
        //public ArrayList StatusSMS(Gateway Gateway,string Id)
        //{
        //    try
        //    {
        ...
        //        objStringBuilder.Append(Environment.NewLine);
        //        objStringBuilder.Append("<smsStatusPoll company=\"" + Gateway.Shenase + "\">");
        //        objStringBuilder.Append(Environment.NewLine);
        //        objStringBuilder.Append("<batch batchID=\"" + Gateway.Shenase + Id + "\" />");
        //        objStringBuilder.Append(Environment.NewLine);
        //        objStringBuilder.Append("</smsStatusPoll>");

        //        string dataToPost = objStringBuilder.ToString();
        //        WebRequest objWebRequest = WebRequest.Create(Gateway.IP);
        //        objWebRequest.Method = "POST";
        //        objWebRequest.ContentType = "text/xml";

        //        byte[] byt = System.Text.Encoding.UTF8.GetBytes(Gateway.Username + ":" + Gateway.Password);
        //        objWebRequest.Headers.Add("authorization", "Basic " + Convert.ToBase64String(byt));
        ...
        public int MyASC(string OneChar)
        {
            ...
            {
                return Microsoft.VisualBasic.Strings.AscW(OneChar);
            }
    ...
    public class ClsGetRemain
    {
        ...
        //public string GetRemainCredit(Gateway Gateway)
        //{
        //    try
        //    {
        //        string SMSBalance = "";
        ...
        //        objStringBuilder.Append("<?xml version=\"1.0\"?>");
        //        objStringBuilder.Append(Environment.NewLine);
        //        objStringBuilder.Append("<getUserBalance company=\"" + Gateway.Shenase + "\" />");
        //        string dataToPost = objStringBuilder.ToString();
